...
# ========== Step 6: 更新任务状态 ⚠️ 必须在提交前完成 ==========
# 编辑 docs/task/task_records.json，更新任务状态：
# {
#   "status": "已完成",
#   "finish_time": "2026-03-24 12:00:00",
#   "check_result": "通过",
#   "remark": "已完成小说列表展示、点击跳转、滑动删除功能"
# }

# ========== Step 7: 提交代码（包含代码+任务记录）==========
git add .
git commit -m "feat: 描述本次修改内容"

# ========== Step 8: 推送分支 ⚠️ 推送后不再修改任务记录 ==========
...
# Step 4: 本地构建验证
echo "[4/9] 本地构建验证（预计5-10分钟）..."
./gradlew assembleDebug

# Step 5: 更新任务状态 ⚠️ 必须在提交前完成
echo "[5/9] 更新任务状态..."
...
# Step 6: 提交代码（包含代码+任务记录）
echo "[6/9] 提交代码（包含任务记录）..."
git add .
git commit -m "${BRANCH_TYPE}: ${DESCRIPTION}"

# Step 7: 推送分支 ⚠️ 推送后不再修改
echo "[7/9] 推送分支..."
echo "⚠️  推送后不再修改任务记录"
git push -u origin "$BRANCH_NAME"

# Step 8: 创建PR
echo "[8/9] 创建Pull Request..."
